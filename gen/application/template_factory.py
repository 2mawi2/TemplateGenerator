    ...
    def __create_crud_templates(self, package_name, entity_name) -> [Template]:
        ...
        templates = [
            ...
            Template(values.test_controller_template,
                     fac.test_controller(package_name, entity_name),
                     self.replacers),
            ...
            Template(values.test_repository_template,
                     fac.test_repository(package_name, entity_name),
                     self.replacers),
            Template(values.crud_api_controller_template,
                     fac.api_controller(package_name, entity_name),
                     self.replacers),
            Template(values.test_api_controller_template,
                     fac.test_api_controller(package_name, entity_name),
                     self.replacers),
        ]
        return templates
